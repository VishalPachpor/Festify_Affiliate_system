...
import { useOrganizerSignupMutation } from "../hooks/use-signup-organizer";
import { organizerSignUpSchema, type OrganizerSignUpFormValues } from "../schemas";

export function OrganizerSignUpForm() {
  const mutation = useOrganizerSignupMutation();

  const { register, formRef, submitWithFocus, isSubmitting, errors } =
    useAuthForm(organizerSignUpSchema, async (data: OrganizerSignUpFormValues) => {
