...
function KpiCardSkeleton({ label }: { label: string }) {
  return (
    <div
      ...
      style={{
        background: "linear-gradient(180deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.01) 40%, transparent 100%), rgba(21,26,43,0.8)",
        boxShadow: "0 0 0 1px rgba(255,255,255,0.06), 0 10px 30px rgba(0,0,0,0.25), 0 2px 8px rgba(0,0,0,0.2)",
      }}
    >
